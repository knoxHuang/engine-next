...
Object.assign(gfx$1, enums$1);

class InputAssembler$1 {
  constructor(vb, ib, pt = gfx$1.PT_TRIANGLES) {
...
class Pass {
  constructor(name) {
    ...
    // cullmode
    this._cullMode = gfx$1.CULL_BACK;

    // blending
    this._blend = false;
    this._blendEq = gfx$1.BLEND_FUNC_ADD;
    this._blendAlphaEq = gfx$1.BLEND_FUNC_ADD;
    this._blendSrc = gfx$1.BLEND_ONE;
    this._blendDst = gfx$1.BLEND_ZERO;
    this._blendSrcAlpha = gfx$1.BLEND_ONE;
    this._blendDstAlpha = gfx$1.BLEND_ZERO;
    this._blendColor = 0xffffffff;

    // depth
    this._depthTest = false;
    this._depthWrite = false;
    this._depthFunc = gfx$1.DS_FUNC_LESS,

    // stencil
    this._stencilTest = false;
    // front
    this._stencilFuncFront = gfx$1.DS_FUNC_ALWAYS;
    this._stencilRefFront = 0;
    this._stencilMaskFront = 0xff;
    this._stencilFailOpFront = gfx$1.STENCIL_OP_KEEP;
    this._stencilZFailOpFront = gfx$1.STENCIL_OP_KEEP;
    this._stencilZPassOpFront = gfx$1.STENCIL_OP_KEEP;
    this._stencilWriteMaskFront = 0xff;
    // back
    this._stencilFuncBack = gfx$1.DS_FUNC_ALWAYS;
    this._stencilRefBack = 0;
    this._stencilMaskBack = 0xff;
    this._stencilFailOpBack = gfx$1.STENCIL_OP_KEEP;
    this._stencilZFailOpBack = gfx$1.STENCIL_OP_KEEP;
    this._stencilZPassOpBack = gfx$1.STENCIL_OP_KEEP;
  ...
  setBlend(
    blendEq = gfx$1.BLEND_FUNC_ADD,
    blendSrc = gfx$1.BLEND_ONE,
    blendDst = gfx$1.BLEND_ZERO,
    blendAlphaEq = gfx$1.BLEND_FUNC_ADD,
    blendSrcAlpha = gfx$1.BLEND_ONE,
    blendDstAlpha = gfx$1.BLEND_ZERO,
    blendColor = 0xffffffff
  ) {
    this._blend = true;
  ...
  setStencilFront(
    stencilFunc = gfx$1.DS_FUNC_ALWAYS,
    stencilRef = 0,
    stencilMask = 0xff,
    stencilFailOp = gfx$1.STENCIL_OP_KEEP,
    stencilZFailOp = gfx$1.STENCIL_OP_KEEP,
    stencilZPassOp = gfx$1.STENCIL_OP_KEEP,
...
class Light {
  ...
  _generateShadowMap(device) {
    this._shadowMap = new gfx$1.Texture2D(device, {
      width: this._shadowResolution,
      height: this._shadowResolution,
      format: gfx$1.TEXTURE_FMT_RGBA8,
      wrapS: gfx$1.WRAP_CLAMP,
      wrapT: gfx$1.WRAP_CLAMP,
    });
    this._shadowDepthBuffer = new gfx$1.RenderBuffer(device,
      gfx$1.RB_FMT_D16,
      this._shadowResolution,
      this._shadowResolution
    );
    this._shadowFrameBuffer = new gfx$1.FrameBuffer(device, this._shadowResolution, this._shadowResolution, {
...
class ProgramLib {
  ...
  getProgram(name, defines) {
    ...
    program = new gfx$1.Program(this._device, {
      vert,
      frag
    });
    program.link();
